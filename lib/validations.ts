...
export const UpdateUserSchema = z.object({ name: z.string().min(2).max(100).optional(), role: z.enum(["ADMIN", "EMPLOYEE", "MANAGEMENT"]).optional(), branches: z.array(z.enum(BRANCHES)).optional(), isActive: z.boolean().optional(), passwordSet: z.boolean().optional() });
